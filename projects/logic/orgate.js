class OrGate {
  constructor(x, y) {
    ...
    this.input1 = new InputOutput(this.pos.x + this.width / 4.8, this.pos.y + this.height * 0.25);
    this.input2 = new InputOutput(this.pos.x + this.width / 4.8, this.pos.y + this.height * 0.75);
  ...
  show() {
    ...
    ellipseMode(CORNER);
    noFill();
    arc(this.pos.x - this.width, this.pos.y, 2 * this.width, this.height, -HALF_PI, HALF_PI);
    arc(this.pos.x - this.width / 4, this.pos.y, this.width / 2, this.height, -HALF_PI, HALF_PI);
